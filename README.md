...
BIA601_Project/
├── backend/
│   ├── main.py               # FastAPI end-points & تطبيق الخوارزمية الجينية
│   ├── requirements.txt      # مكتبات Python المطلوبة
│   ├── users.xlsx            # بيانات المستخدمين
│   ├── products.xlsx         # بيانات المنتجات
│   ├── ratings.xlsx          # بيانات التقييم (يتم توليده إن لم يوجد)
│   └── behavior_15500.xlsx   # بيانات تفاعل وسلوك المستخدمين
├── frontend/
...
| **البيانات** | قراءة وتحليل ملفات Excel (xlsx) باستخدام Pandas |
...
2. **إعداد وتشغيل الخادم الخلفي (Backend)**
   ...
   ```
   *بمجرد ظهور رسالة "تم تحميل جميع ملفات Excel بنجاح"، سيعمل الخادم على الرابط: `http://127.0.0.1:8000`*
