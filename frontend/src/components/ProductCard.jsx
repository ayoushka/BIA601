...
export default function ProductCard({ product, setId, onInteraction }) {
  ...
  return (
    <div
      className={`min-w-[280px] sm:min-w-[320px] max-w-[320px] bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden flex flex-col group transition-all duration-400 ease-[cubic-bezier(0.25,0.8,0.25,1)] hover:-translate-y-2 hover:shadow-2xl hover:border-slate-300 relative ${product.isMutation ? 'ring-2 ring-brand-gold ring-offset-2' : ''
        }`}
    >
        ...
        <div className="flex flex-col gap-2 mt-auto">
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              disabled={justAdded}
              className={`flex items-center justify-center gap-1.5 py-2 rounded-lg transition-all font-semibold text-xs shadow-sm active:scale-95 group/btn ${justAdded
            ...
            <button
              ...
              disabled={justBought}
              className={`flex items-center justify-center gap-1.5 py-2 rounded-lg transition-all font-bold text-xs shadow-sm active:scale-95 group/btn ${justBought
